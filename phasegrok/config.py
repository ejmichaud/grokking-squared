...
parser.add_argument('--lr_decoder', type=float, default=0.001, metavar='LR')
parser.add_argument('--lr_rep', type=float, default=0.01, metavar='LR')
...
parser.add_argument('--p', type=int, default=10, help='number of datapoints')
parser.add_argument('--m', type=int, default=0, help='modulus')
parser.add_argument('--split_ratio', type=float, default=0.8,
                    help="train/test split ratio")
parser.add_argument('--latent_dim', type=int, default=2, metavar='N',
                    help='latent dimension')
parser.add_argument('--decoder_width', type=int, default=200, metavar='N',
                    help='decoder width')
parser.add_argument('--decoder_depth', type=int, default=1, metavar='N',
                    help='decoder depth')
